...
const Friend = ({friendId, name, subtitle, userPicturePath}) => {
    ...
    const patchFriend = async () => {
        ...
        data.profileImageURL = userPicturePath;
            ...
            <FlexBetween gap="1rem">
                ...
                <Box onClick={() => {
                    navigate(`/profile/${friendId}`);
                     // refresh the page to fix a bug where navigating to another user from the new page doesn't update react elements, edge case needs better fix later
                }}>
